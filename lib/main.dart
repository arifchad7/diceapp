...
void main() {
  runApp(MaterialApp(
    ...
    home: Scaffold(
      ...
      body: SingleChildScrollView(child: DicePage()),
    ),
  ));
}
  ...
  Expanded left() {
    return Expanded(
      child: FlatButton(
        ...
        child: Image.asset(
          'images/assets/dice$top_left.png',
          color: Colors.black,
        ),
      ),
    );
  ...
  Expanded right() {
    return Expanded(
      child: FlatButton(
        ...
        child: Image.asset(
          'images/assets/dice$top_right.png',
          color: Colors.black,
        ),
      ),
    );
  ...
  Expanded upper() {
    return Expanded(
      child: FlatButton(
        ...
        child: Image.asset(
          'images/assets/dice$bottom_left.png',
          color: Colors.black,
        ),
      ),
    );
  ...
  Expanded lower() {
    return Expanded(
      child: FlatButton(
        ...
        child: Image.asset(
          'images/assets/dice$bottom_right.png',
          color: Colors.black,
        ),
      ),
    );
